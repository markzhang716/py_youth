...
MeTreeNode =TreeNode('Me')
WennyTreeNode =TreeNode('Wenny')

HenryTreeNode.add(JoeTreeNode)
HenryTreeNode.add(MeTreeNode)
HenryTreeNode.add(WennyTreeNode)

print([x.data for x in HenryTreeNode.children])

JoeTreeNode.add(TreeNode("Joe's man1"))
JoeTreeNode.add(TreeNode("Joe's man2"))
JoeTreeNode.add(TreeNode("Joe's man3"))
JoeTreeNode.add(TreeNode("Joe's man4"))
JoeTreeNode.add(TreeNode("Joe's man5"))

MeTreeNode.add(TreeNode("My man1"))
MeTreeNode.add(TreeNode("My man2"))
MeTreeNode.add(TreeNode("My man3"))
MeTreeNode.add(TreeNode("My man4"))
MeTreeNode.add(TreeNode("My man5"))
WennyTreeNode.add(TreeNode('Pet'))
HenryTreeNode.print()
HenryTreeNode.tree_print()
